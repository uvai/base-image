...
UNET_MODELS=(
    ...
    "https://huggingface.co/lodestones/Chroma/resolve/main/chroma-unlocked-v39.safetensors"
    "https://huggingface.co/lodestones/Chroma/resolve/main/chroma-unlocked-v39-detail-calibrated.safetensors"
)
